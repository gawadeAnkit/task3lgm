      ...
      <div class="login-content-header">
          <form action="login.php" method="post">
           ...
           <table class="form1">
            <tr>
            <th>Username </th>
            <td class="table"><input type="text" name="username" placeholder=" Username" class="field1"/></td>  
            </tr> 
            <tr >
            <th>Password </th>
            <td class="table"><input type="password" name="password" placeholder=" Password" class="field1"/></td>
            </tr>   
            <tr>
